	...
	<div class="row">
		<aside class="col-md-3 col-sm-3">
			...
			<div class="list-group">
				...
				[logged]<a class="list-group-item[if SELF="{PATH}user/profile/{username}"] active[/if]" href="{profile-link}"><span class="fa fa-fw fa-user"></span>&nbsp; [f:main:user.profile]</a>
				[if installed-module:messages]<a class="list-group-item" href="{messages-link}"><span class="fa fa-fw fa-envelope"></span>&nbsp; [b:messages:moduleName]</a>[/if]
