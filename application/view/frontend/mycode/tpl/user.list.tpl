...
<article class="card">
	...
	<span class="status">[online]<span class="online">[f:user:profile.status.online]</span>[/online][offline][f:user:profile.status.offline] {last-online-date} в {last-online-time}[/offline]</span>
	<div class="panel">
