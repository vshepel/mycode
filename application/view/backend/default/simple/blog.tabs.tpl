<ul class="nav nav-tabs" role="tablist">
	<li[if ACTION="statistics"] class="active"[/if]><a href="{ADMIN_PATH}blog/statistics">
		<span class="main-row-icon fa fa-dashboard"></span> [b:blog:statistics.moduleName]
	</a></li>

	<li[if ACTION="settings"] class="active"[/if]><a href="{ADMIN_PATH}blog/settings">
		<span class="main-row-icon fa fa-cog"></span> [b:blog:settings.moduleName]
	</a></li>
