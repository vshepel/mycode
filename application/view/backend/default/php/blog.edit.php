...
<form method="post" class="form-horizontal">
	<div class="form-group">
		<label class="control-label col-sm-3"><?=$this->_flang("blog", "edit.form.author")?> *</label>
		<div class="col-sm-9">
			<div class="input-group">
				<span class="input-group-addon" id="basic-addon1"><span class="fa fa-user"></span></span>
				<input class="form-control" type="text" name="author" value="<?=$tags["author-login"]?>" disabled>
			</div>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<button class="btn btn-success"><span class="fa fa-save"></span> <?=$this->_flang("blog", "edit.form.submit")?></button>
			<a href="<?=$tags["list-link"]?>"  class="btn btn-primary"><span class="fa fa-remove"></span> <?=$this->_flang("blog", "edit.link.cancel")?></a>
			<a href="<?=$tags["remove-link"]?>" class="btn btn-danger"><span class="fa fa-trash"></span> <?=$this->_flang("blog", "edit.link.remove")?></a>
		</div>
	</div>
</form>
