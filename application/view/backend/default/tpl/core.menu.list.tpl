...
<table class="table">
	<thead><tr>
		...
		<th style="width: 40px">[f:core:menu.list.table.icon]</th>
		<th style="width: 150px">[f:core:menu.list.table.link]</th>
		<th>[f:core:menu.list.table.title]</th>
		<th style="width: 100px;">[f:core:menu.list.table.pos]</th>
	...
	<tbody>
		[foreach rows]<tr [edit] class="info"[/edit]"><form method="post">[not-edit]
			...
			<td>{id}</td>
			<td align="center"><span class="fa fa-{icon}"></span></td>
		...
		[/not-edit][edit]
			...
			<td colspan="2" style="padding: 3px">
				<input type="text" class="form-control input-sm" name="edit[icon]" value="{icon}">
			</td>
			<td colspan="1" style="padding: 3px">
				<input type="text" class="form-control input-sm" name="edit[link]" value="{link}">
			</td>
			<td colspan="1" style="padding: 3px">
				<input type="text" class="form-control input-sm" name="edit[title]" value="{original-title}">
			</td>
			<td colspan="1" style="padding: 3px">
				<input type="text" class="form-control input-sm" name="edit[pos]" value="{pos}">
			</td>
			<td style="padding: 3px">
				<button type="submit" class="btn btn-primary btn-sm" style="width:100%"><span class="glyphicon glyphicon-floppy-disk"></span></button>
			</td>
		[/edit]</form></tr>[/foreach]

		<tr><form method="post">
			<input type="hidden" name="add[type]" value="{type}">
			<td colspan="2" style="padding: 3px">
